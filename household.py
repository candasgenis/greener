class household:
    ...
    def __init__(self,home_id,house_type = "Undefined",number_of_rooms = 0,heating_type = "Undefined",insulation = "Undefined",kwh_electricity = 0,kwh_gas = 0, carbon_emission=0):
